...
X_nondynamic_train, Y_nondynamic_train=common.getDataSubset(X_train, Y_train, [1,2,3])

X_dynamic_test, Y_dynamic_test=common.getDataSubset(X_test, Y_test, [1,2,3])
X_nondynamic_test, Y_nondynamic_test=common.getDataSubset(X_test, Y_test, [1,2,3])

X_nondynamic_train=common.getPowerK(X_nondynamic_train, [1,2])
X_nondynamic_test=common.getPowerK(X_nondynamic_test, [1,2])
...
#Y_nondynamic_train_sublabels=common.convertLabel(Y_nondynamic_train, [4,5], [6])
...
sample_weights=common.getSampleWeights( X_nondynamic_train, Y_nondynamic_train , [1,2,3])
...
clf.fit(X_nondynamic_train, Y_nondynamic_train, sample_weight=sample_weights)
...
prec, rec, f_score=common.checkAccuracy(Y_nondynamic_test, Y_predict_nondynamic, [1,2,3])
print prec
print rec
print f_score
print common.createConfusionMatrix(Y_predict_nondynamic, Y_nondynamic_test, [1,2,3])
#print clf.n_support_
